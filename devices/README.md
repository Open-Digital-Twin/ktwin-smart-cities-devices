...
docker run -it --rm \
    ...
    -e BROKER_PORT=1883 \
    -e NUMBER_DEVICES=5 \
    -e BROKER_TOPIC_1=mytopic-01 \
    -e CLIENT_ID_1=mqtt-client-id-publisher-01 \
    -e BROKER_TOPIC_2=mytopic-02 \
    -e CLIENT_ID_2=mqtt-client-id-publisher-02 \
    -e BROKER_TOPIC_3=mytopic-03 \
    -e CLIENT_ID_3=mqtt-client-id-publisher-03 \
    -e BROKER_TOPIC_4=mytopic-04 \
    -e CLIENT_ID_4=mqtt-client-id-publisher-04 \
    -e BROKER_TOPIC_5=mytopic-05 \
    -e CLIENT_ID_5=mqtt-client-id-publisher-05 \
    -e USERNAME= \
    -e PASSWORD= \
