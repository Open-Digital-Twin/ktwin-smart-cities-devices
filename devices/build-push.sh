...
docker buildx build -f publisher.Dockerfile -t ghcr.io/open-digital-twin/ktwin-pole-crowd-flow-observed-device-publisher:0.1 --build-arg DEVICE_NAME=pole-crowd-flow-observed-device .
docker buildx build -f publisher.Dockerfile -t ghcr.io/open-digital-twin/ktwin-pole-traffic-flow-observed-device-publisher:0.1 --build-arg DEVICE_NAME=pole-traffic-flow-observed-device .
...
docker buildx build -f subscriber.Dockerfile -t ghcr.io/open-digital-twin/ktwin-pole-crowd-flow-observed-device-subscriber:0.1 --build-arg DEVICE_NAME=pole-crowd-flow-observed-device .
docker buildx build -f subscriber.Dockerfile -t ghcr.io/open-digital-twin/ktwin-pole-traffic-flow-observed-device-subscriber:0.1 --build-arg DEVICE_NAME=pole-traffic-flow-observed-device .
docker buildx build -f subscriber.Dockerfile -t ghcr.io/open-digital-twin/ktwin-pole-noise-level-observed-device-subscriber:0.1 --build-arg DEVICE_NAME=pole-noise-level-observed-device .
