...
docker buildx build -f publisher.Dockerfile -t ghcr.io/open-digital-twin/ktwin-pole-crowd-flow-observed-device-publisher:0.1 --build-arg DEVICE_NAME=pole-crow-flow-observed-device .
